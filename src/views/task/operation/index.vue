...
import { taskListApi, taskInfo, cancel, allTaskStatus } from '@/api/task'
import addTask from '@/views/task/business/components/addTask.vue'
export default {
  name: 'Business',
  components: { myList, myHeader, myPagination, addTask },
  data() {
    return {
      page: {
        pageIndex: 1, // 当前页码
        pageSize: 10, // 当前页的数据量
        isRepair: true // 是否维修工单
      },
      list: [], // 工单数据
      total: 0, // 总数,
      totalPage: 0, // 总页数,
